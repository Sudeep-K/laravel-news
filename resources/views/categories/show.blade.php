...
<head>
    ...
    <title>Category | Laravel News</title>
...
<body>
    ...
    <div class="max-w-5xl mx-auto my-16">
        <h2 class="text-xl font-semibold leading-7 text-gray-900"><span class="font-bold">Name:</span> {{ $category->name }}</h2>
        <h2 class="text-lg font-semibold leading-7 text-gray-900"><span class="font-bold">Slug:</span> {{ $category->slug }}</h2>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                <a href="{{ route('categories.edit', ['category' => $category->id]) }}" class="font-medium text-white-600 hover:underline">Edit</a>
            </button>
        </div>
    </div>
